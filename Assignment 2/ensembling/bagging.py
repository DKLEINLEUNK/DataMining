""" Bagging ensemble method for Random Forest Classifier """
...
PATH_EXPORT = "/home/david/Studies/Data Mining Techniques/repository/Assignment 2/pending_submissions/bagging.csv"
...
bagging = BaggingClassifier(clf, max_samples=0.5, max_features=0.5)  # TODO - Try different values for max_samples and max_features (probably needs to be a bit lower)
bagging.fit(X_train, y_train)

# Rank & sort the results
y_pred = bagging.predict(df_test)
